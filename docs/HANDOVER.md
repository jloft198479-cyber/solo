...
status: active
tags: [交接, 入门, 真理源地图]
summary: 接手入口：30 秒定位 + 真理源文件表 + 环境搭建
updates: [AGENTS.md, ARCHITECTURE.md, BUILD_GUIDE.md, docs/KNOWN-ISSUES.md]
---
...
4. 按需：[BUILD_GUIDE.md](../BUILD_GUIDE.md)（编译）、[TROUBLESHOOTING.md](./TROUBLESHOOTING.md)（用户侧问题）、[docs/](./)（专题）
5. 接手专用（本批新增）：[docs/KNOWN-ISSUES.md](./KNOWN-ISSUES.md)、[docs/debugging.md](./debugging.md)、[docs/INDEX.md](./INDEX.md)
...
| Rust **命令总数/注册** | [src-tauri/src/lib.rs](../src-tauri/src/lib.rs) 的 `generate_handler!`（**数量以其为准，勿在文档硬编码**） |
