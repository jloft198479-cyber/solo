      ...
      <div v-if="isActive" class="quick-popover">
        ...
        <div class="quick-popover-list">
          <button class="quick-popover-option" @click="doExport('html')">
            <svg class="export-glyph" style="background:var(--warning-color)" width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
          ...
          <button class="quick-popover-option" @click="doExport('pdf')">
            <svg class="export-glyph" style="background:var(--error-color)" width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
          ...
          <button class="quick-popover-option" @click="doExport('wechat')">
            <svg class="export-glyph" style="background:var(--success-color)" width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
